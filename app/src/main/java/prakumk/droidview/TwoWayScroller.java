...
public class TwoWayScroller extends FrameLayout {
    private static final String TAG = TwoWayScroller.class.getSimpleName();
    ...
    public TwoWayScroller(Context context) {
        this(context, null);
    }

    public TwoWayScroller(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoWayScroller(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        initScrollView();

        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.TwoWayScroller, defStyleAttr, defStyleAttr);

        setFillViewport(a.getBoolean(R.styleable.TwoWayScroller_fillViewport, false));
        a.recycle();
    }
...
//            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(TwoWayScroller.class.getName());
        if (isEnabled()) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TwoWayScroller.class.getName());
...
//            postInvalidateOnAnimation();
     ...
     * {@link View#FOCUS_LEFT} to go one page left or
     * {@link View#FOCUS_RIGHT} to go one page right or
     * {@link View#FOCUS_UP} to go one page up or
...
//            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return TwoWayScroller.class.getCanonicalName()
